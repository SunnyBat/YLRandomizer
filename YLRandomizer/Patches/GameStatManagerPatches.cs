...
namespace YLRandomizer.Patches
{
    ...
    public class GameStatManager_HasConditionBeenMet
    {
        ...
        {
            // This is called a LOT, don't print here
            if (condition.Stat == EGameStats.PagiesCollected && condition.Value == 100)
            {
                ...
                __result = OperationTools.Compare(ManualSingleton<IRandomizer>.instance.GetAllItems().Length, condition.Value, condition.ComparisonOperator);
